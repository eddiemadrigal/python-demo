...
class Waypoint(LatLon):
    ...
    def __str__(self):
        return "Hi there. For {}, the latitude is {}, longitude is {}.".format(self.name, self.lat, self.lon)
...
class Geocache(Waypoint):
    ...
    def __str__(self):
        return "{} has a difficulty: {}, size: {}, latitude of {} and longitude of {}.".format(self.name, self.difficulty, self.size, self.lat, self.lon)
